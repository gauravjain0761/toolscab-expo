                ...
                <ScrollView style={styles.container}>
                    <View style={styles.contentView}>
                        ...
                        <View style={styles.bottomView}>
                            <View>
                                <View style={{ flex: 1 }}>
                                    <Text style={{ ...commonFontStyle(fontFamily.semiBold, 90, colors.Roheline2), letterSpacing: -2.5, }}>0<Text style={{ fontSize: 52 }}>.22</Text><Text style={commonFontStyle(fontFamily.semiBold, 21, colors.Roheline2)}>€</Text></Text>
                                </View>
                                <View style={[styles.priceViewMob, { position: 'absolute', bottom: 15, width: '100%', paddingLeft: 20 }]}>
                                    <Text style={commonFontStyle(fontFamily.articulat_regular, 10, colors.filterText)}>26€ / 24h</Text>
                                    <Text style={commonFontStyle(fontFamily.articulat_regular, 11, colors.headerBG)}>Minut</Text>
                                </View>
                            </View>
                            <View style={{ marginLeft: 30, flexDirection: 'row', alignItems: 'center' }}>
                                <Image style={styles.arrowImageMob} source={require('../../assets/icon/bottomArrow.png')} />
                                <Text style={commonFontStyle(fontFamily.articulat_regular, 11.4, colors.black)}>Kuidas hind kujuneb ?</Text>
                            </View>

                        </View>
                        <View style={styles.botomLineMob} />
                        <Text style={[styles.prodDes2, { marginTop: heightPercentageToDP(2) }]}>Tekstiilipesur</Text>
                        <Text style={styles.prodDes2}>Voolik</Text>
                        <Text style={[styles.prodDes2, { marginBottom: heightPercentageToDP(2) }]}>Pesuaine</Text>
                        <View style={styles.botomLineMob} />
                        <View style={styles.btnRowMob}>
                            <CommonGreenBtn title='Rendi' onPress={() => { }} style={{ width: '40%' }} />
                            <CommonGreenBtn title='Leia kapp' onPress={() => { }} style={{
                                backgroundColor: colors.white,
                                borderColor: colors.black,
                        ...
                        <Text style={styles.desProduct}>Polstri- ja põrandaotsikuga Puzzi 10/1 sobib eriti hästi suuremate ja keskmiste pindade hügieeniliseks puhastamiseks. 1 baari suuruse piserdusrõhuga kannab süvapesuseade hoolt tekstiilpindade säästva sügavpuhastuse eest ja annab eriti polstrite ja vaipkatete puhastamisel veenvaid tulemusi. Tänu kitsale põrandaotsikule sobib seade suurepäraselt ka kitsamates ruumitingimustes töötamiseks. Ning tänu painduvale kummiraaklile saab muretult puhastada ka möbleeritud pindasid. Süvapesuseade on varustatud integreeritud juhtmekonksu ja käsitööriistade ning imemisvooliku kinnitusega.</Text>
                    </View>
...
const styles = StyleSheet.create({
    ...
    arrowImageMob: {
        height: 26, width: 26, resizeMode: 'contain', marginRight: 10
    },
    botomLineMob: {
        height: 1,
