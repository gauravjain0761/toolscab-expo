...
const AppDrawerModal = ({ isVisible }: Props) => {
    ...
    return (
        <Modal
            ...
            style={{ margin: 0 }}
            backdropColor={colors.headerBG} backdropOpacity={1} isVisible={isVisible}>
            <View style={styles.mainContainer}>
                <SafeAreaView>
                    ...
                    <TouchableOpacity onPress={() => {
                        navigationRef.navigate(screenName.productFilter),
                            onClose()
                    }} style={styles.row}>
...
const styles = StyleSheet.create({
    ...
    imput: { flex: 1, marginLeft: 10, height: 50, ...defaultFont(400, 16, colors.white) },
    row: {
